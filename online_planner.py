...
class OnlinePlanner(LeafSystem):
    def __init__(
        ...
        self.mode_0_traj = mode_0_traj
        self.mode_1_traj = mode_1_traj
        self.mode_2_traj = mode_2_traj
        ...
        self.right_left_traj_output_port_index = self.DeclareAbstractOutputPort(
            "left_foot_traj",
            lambda: AbstractValue.Make(PiecewisePolynomial()),
            self.CalcLFTraj,
        ).get_index()
